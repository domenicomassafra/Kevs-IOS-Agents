...
const devices: RegisteredDevice[] = [
    { name: 'Android A', udid: 'a', platform: 'android', kind: 'emulator', workerId: 'linux1', pluginData: {} },
    { name: 'Android B', udid: 'b', platform: 'android', kind: 'emulator', workerId: 'linux2', pluginData: {} },
